        ...
        return new DefaultAssetAdministrationShell.Builder()
                ...
                .assetInformation(new DefaultAssetInformation.Builder()
                        ...
                        .specificAssetId(new DefaultSpecificAssetId.Builder()
                                ...
                                .externalSubjectId(new DefaultExternalReference.Builder()
...
//                                        .type(ReferenceTypes.EXTERNAL_REFERENCE)
                        ...
                        .defaultThumbnail(new DefaultResource.Builder()
                                ...
                                .build())
                        .build())
                .submodel(new DefaultModelReference.Builder()
                        .key(new DefaultKey.Builder()
...
//                        .type(ReferenceTypes.EXTERNAL_REFERENCE)
                        .build())
                .submodel(
                        new DefaultModelReference.Builder()
                                .key(new DefaultKey.Builder()
                                        .type(KeyTypes.SUBMODEL)
...
//                                .type(ReferenceTypes.EXTERNAL_REFERENCE)
    ...
    public static Environment createEnvironment() {
        return new DefaultEnvironment.Builder()
                ...
                .submodel(createSubmodelTechnicalData())
                .submodel(createSubmodelDocumentation())
                .submodel(createSubmodelOperationalData())
                .conceptDescription(createConceptDescriptionTitle())
                .conceptDescription(createConceptDescriptionDigitalFile())
                .conceptDescription(createConceptDescriptionMaxRotationSpeed())
                .conceptDescription(createConceptDescriptionRotationSpeed())
                .conceptDescription(createConceptDescriptionDocument())
                .build();
    }
