...
public class XmlSerializerTest {
    ...
    public void validateConceptDescriptionAgainstXsdSchema() throws SerializationException, SAXException {
        ...
        Set<String> errors = validateAgainstXsdSchema( new XmlSerializer().write(new DefaultEnvironment.Builder().conceptDescription(object).build()));
    ...
    public void validateMinimalOperationAgainstXsdSchema() throws SerializationException, SAXException {
        Submodel object = new DefaultSubmodel.Builder()
                ...
                .submodelElement(new DefaultOperation.Builder()
                        ...
                        .build())
        .build();
        String xml = new XmlSerializer().write(new DefaultEnvironment.Builder().submodel(object).build());
    ...
    public void validateGYearAgainstXsdSchema() throws SerializationException, SAXException {
        Submodel submodel = new DefaultSubmodel.Builder().id("yearTestSm").submodelElement(new DefaultProperty.Builder().idShort("yearTestProp").valueType(DataTypeDefXsd.GYEAR).build()).build();
        String xml = new XmlSerializer().write(new DefaultEnvironment.Builder().submodel(submodel).build());
        Set<String> errors = validateAgainstXsdSchema(xml);
        assertTrue(errors.isEmpty());
    }
    ...
    public void validateIsCaseOfAgainstXsdSchema() throws SerializationException, SAXException {
        ...
        String xml = new XmlSerializer().write(new DefaultEnvironment.Builder().conceptDescription(object).build());
        Set<String> errors = validateAgainstXsdSchema( xml );
        assertTrue(errors.isEmpty());
    }
